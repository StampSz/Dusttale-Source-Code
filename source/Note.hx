			...
			switch (PlayState.SONG.noteStyle)
			{
				...
				default:
						...
						switch(noteType)
						{
							case 2:
							{
								frames = Paths.getSparrowAtlas('NotesKR/NOTE_assets_KR');
							...
							case 3:
							{
								frames = Paths.getSparrowAtlas('NotesKR/NOTE_assets_Dust');
								animation.addByPrefix('greenScroll', 'green0');
								animation.addByPrefix('redScroll', 'red0');
								animation.addByPrefix('blueScroll', 'blue0');
								animation.addByPrefix('purpleScroll', 'purple0');
							...
							case 4:
							{
								frames = Paths.getSparrowAtlas('NotesKR/NOTE_assets_phantom');
								animation.addByPrefix('greenScroll', 'green0');
								animation.addByPrefix('redScroll', 'red0');
								animation.addByPrefix('blueScroll', 'blue0');
								animation.addByPrefix('purpleScroll', 'purple0');
